...
<!-- Typing SVG -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=Hello,+World!;I+focus+on+AI+and+UI/UX.;Learning+and+building+cool+stuff.;Welcome+to+my+GitHub+profile!&font=Fira%20Code&size=25&duration=2000&color=00BFF6&center=true" alt="Typing SVG" />
</p>
...
<!-- 3D 贡献图：直接引用仓库内已提交的文件，不依赖 Actions -->
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./profile-3d-contrib/profile-night-green.svg">
    <source media="(prefers-color-scheme: light)" srcset="./profile-3d-contrib/profile-green-animate.svg">
    <img alt="github profile 3d contrib" src="./profile-3d-contrib/profile-green-animate.svg">
  </picture>
</p>

<!-- Snake 动画：优先 output 分支；若失效可运行 scripts/update-snake.ps1 本地更新 -->
<p align="center">
  <picture>
